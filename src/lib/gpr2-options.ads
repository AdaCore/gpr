...
package GPR2.Options is
   ...
   function Filename (Self : Object) return GPR2.Path_Name.Object
     with Pre => Self.Is_Finalized;
   ...
   function Environment (Self : Object) return GPR2.Environment.Object
     with Pre => Self.Is_Finalized;
   --  The environment used to laod the project
...
private
   ...
   function Base (Self : Object) return GPR2.KB.Object is
     (GPR2.KB.Create
   ...
   function Filename (Self : Object) return GPR2.Path_Name.Object is
   ...
   function Project_Is_Defined (Self : Object) return Boolean is
     (Self.Project_Is_Defined);
