...
package GPR2.Build.Actions.Process.Link.Partial is

   type Partial_Link_Id (<>) is new Actions.Process.Link.Link_Id with private;

   type Object is new Actions.Process.Link.Object with private;
...
private
   ...
   type Partial_Link_Id is new Actions.Process.Link.Link_Id with null record;

   overriding function Action_Class
     (Self : Partial_Link_Id) return Value_Type is ("Partial Link");

   type Object is new Actions.Process.Link.Object with record
