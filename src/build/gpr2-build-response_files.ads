...
private
   ...
   type Object is tagged record
      ...
      Primary_FD          : GNATCOLL.OS.FS.File_Descriptor := GOF.Invalid_FD;
      Primary_Path        : Unbounded_String;
      Primary_Content     : GNATCOLL.OS.Process.Argument_List;

      Secondary_FD        : GNATCOLL.OS.FS.File_Descriptor := GOF.Invalid_FD;
      Secondary_Path      : Unbounded_String;
      Secondary_Content   : GNATCOLL.OS.Process.Argument_List;
