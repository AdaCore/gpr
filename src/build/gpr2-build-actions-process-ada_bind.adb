...
package body GPR2.Build.Actions.Process.Ada_Bind is

   Traces : constant GNATCOLL.Traces.Trace_Handle :=
              GNATCOLL.Traces.Create
                ("GPR.BUILD.ACTIONS.PROCESS.ADA_BIND", GNATCOLL.Traces.Off);
   ...
   function Link (Self : Object) return Actions.Process.Link.Object'Class;
   ...
   function Link_Opt_Insert
     (Self : Object) return Link_Options_Insert.Object;
   ...
   function Link (Self : Object) return Actions.Process.Link.Object'Class is

      function Internal_Link
        (Current_Artifact : Artifacts.Object'Class)
         return Actions.Process.Link.Object'Class;
      ...
      begin
         for Action of Self.Tree.Successors (Current_Artifact) loop
            if Action in Actions.Process.Link.Object'Class then
               ...
               --  object as an input
               return Actions.Process.Link.Object'Class (Action);
            end if;
         end loop;

         return Actions.Process.Link.Undefined;
      end Internal_Link;
   begin
   ...
   function Link_Opt_Insert
     (Self : Object) return Link_Options_Insert.Object is
   begin
      for Action of Self.Tree.Successors (Self.Post_Bind.Object_File) loop
         if Action in Link_Options_Insert.Object'Class then
            return Link_Options_Insert.Object (Action);
         end if;
      end loop;

      return Link_Options_Insert.Undefined;
   end Link_Opt_Insert;
   ...
   is
      UID       : constant Actions.Action_Id'Class := Object'Class (Self).UID;
      Post_Bind : Actions.Process.Post_Bind.Object;
   ...
   begin
      ...
      for CU of Self.Roots loop
         declare
            Ada_Comp : Compile.Ada.Object;
            Link     : constant Actions.Process.Link.Object'Class := Self.Link;
         begin
   ...
   function Post_Bind
     (Self : Object) return Actions.Process.Post_Bind.Object is
   begin
      for Succ of Self.Tree.Successors (Self.Output_Body) loop
         if Succ in Actions.Process.Post_Bind.Object'Class then
            return Actions.Process.Post_Bind.Object (Succ);
         end if;
      end loop;
   ...
   is
      ...
      Link            : constant Actions.Process.Link.Object'Class :=
                          Self.Link;
      Link_Opt_Insert : constant Actions.Process.Link_Options_Insert.Object :=
   ...
   begin
      ...
      if not Link.Is_Defined then
         ...
         if Link_Opt_Insert.Is_Defined then
            ...
            for Opt of Self.Linker_Opts loop
               Traces.Trace ("* '" & Opt & "'");
               Actions.Process.Link_Options_Insert.Object
...
end GPR2.Build.Actions.Process.Ada_Bind;
