...
limited with GPR2.Build.Actions.Process.Compile.Ada;
limited with GPR2.Build.Actions.Process.Post_Bind;
...
package GPR2.Build.Actions.Process.Ada_Bind is
   ...
   function Post_Bind (Self : Object) return Actions.Process.Post_Bind.Object;
