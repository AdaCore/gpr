...
package body GPR2.Build.Actions.Process.Archive_Table_List is
   ...
   is
      ...
      Archive_Extract      : Actions.Process.Archive_Extract.Object;
      Link_Options_Extract : Actions.Process.Link_Options_Extract.Object;
   begin
...
end GPR2.Build.Actions.Process.Archive_Table_List;
