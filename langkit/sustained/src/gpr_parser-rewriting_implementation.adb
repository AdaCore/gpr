        ...
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_Access_Subp,
               (1 => Ada_Access_Subp_F_Subp_Kind, 2 => Ada_Access_Subp_F_Skips));
         end;
      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_Pragma,
               (1 => Ada_Pragma_F_Skips));
         end;
      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_With,
               (1 => Ada_With_F_Has_Limited, 2 => Ada_With_F_Has_Private, 3 => Ada_With_F_Packages));
         end;
      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_Generic,
               (1 => Ada_Generic_F_Skips));
         end;
      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_Library_Item,
               (1 => Ada_Library_Item_F_Generic_Stub, 2 => Ada_Library_Item_F_Separate, 3 => Ada_Library_Item_F_Main));
         end;
      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_Pkg,
               (1 => Ada_Pkg_F_Has_Private, 2 => Ada_Pkg_F_Name));
         end;
      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_Pkg_Body,
               (1 => Ada_Pkg_Body_F_Name));
         end;
      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_Subp,
               (1 => Ada_Subp_F_Subp_Kind, 2 => Ada_Subp_F_Name));
         end;
      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_Prelude,
               (1 => Ada_Prelude_F_Context_Clauses, 2 => Ada_Prelude_F_Library_Item));
         end;
      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_Separate,
               (1 => Ada_Separate_F_Parent_Name));
         end;
      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Gpr_Ada_With_Formal,
               (1 => Ada_With_Formal_F_Kind, 2 => Ada_With_Formal_F_Skips));
         end;
