...
package body Gpr_Parser_Support.Adalog.Generic_Main_Support is
   ...
   procedure Solve_All (Rel : Relation; Timeout : Natural := 0) is
      ...
      package Solution_Vectors is new Gpr_Parser_Support.Vectors
        (Solution_Access);
      ...
      function Image is new Gpr_Parser_Support.Images.Array_Image
