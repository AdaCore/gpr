...
package Gpr_Parser_Support.Internal.Conversions is
   ...
   --  expose them in the Gpr_Parser_Support.Generic_API package tree: publish
   --  here declarations as proxies to the implementations in
   --  Gpr_Parser_Support.Generic_API bodies.
   --
   --  Converters for analysis contexts.  See the corresponding export
   --  declaration in Gpr_Parser_Support.Generic_API.Analysis.
   ...
   --  in Gpr_Parser_Support.Generic_API.Analysis.
...
end Gpr_Parser_Support.Internal.Conversions;
