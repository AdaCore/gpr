...
package Gpr_Parser_Support.Generic_API.Analysis is

   type Lk_Context is tagged private;
   type Lk_Unit is new Gpr_Parser_Support.Text.Text_Buffer_Ifc with private;
...
private
   ...
   type Lk_Unit is new Gpr_Parser_Support.Text.Text_Buffer_Ifc with record
