...
with Gpr_Parser_Support.Array_Utils;

package body Gpr_Parser_Support.Cheap_Sets is
   ...
   is new Gpr_Parser_Support.Array_Utils
...
end Gpr_Parser_Support.Cheap_Sets;
