...
use Gpr_Parser.Rewriting_Implementation;

private package Gpr_Parser.Unparsing_Implementation is
   ...
   is record
      case Kind is
         when From_Parsing   => Parsing_Node   : Bare_Gpr_Node;
   ...
   function Kind (Node : Abstract_Node) return Gpr_Node_Kind_Type;
   ...
   function Rewritten_Node
     (Node : Abstract_Node) return Bare_Gpr_Node;
   ...
   type Node_Unparser_Map is array (Gpr_Node_Kind_Type) of Node_Unparser;
