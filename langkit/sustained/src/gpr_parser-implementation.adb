...
--# property-start Limited.Absent.as_bool /media/psf/Home/src/gpr/langkit/language/parser/decl.py:14
pragma Warnings (Off, "is not referenced");
...
--# property-start Limited.Present.as_bool /media/psf/Home/src/gpr/langkit/language/parser/decl.py:14
pragma Warnings (Off, "is not referenced");
