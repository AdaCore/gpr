...
with Gpr_Parser_AdaSAT.Builders;
...
package body Gpr_Parser_Support.Adalog.Solver is
   ----------------------
   -- Supporting types --
   ----------------------

   package Atomic_Relation_Vectors is new Gpr_Parser_Support.Vectors
     (Atomic_Relation);
   ...
   package Positive_Vectors is new Gpr_Parser_Support.Vectors (Positive);
   ...
   type Atom_Mapping is array (Positive range <>)
     of Gpr_Parser_AdaSAT.Variable_Or_Null;
   --  Array type used to map basic block ids to Gpr_Parser_AdaSAT formula variables
   ...
   package BB_Vectors is new Gpr_Parser_Support.Vectors
   ...
   package Unified_Vars_Vectors is new Gpr_Parser_Support.Vectors
     (Unified_Vars);
   ...
   function Evaluate_Atoms
     (Ctx          : in out Solving_Context;
      ...
      Explanation  : in out Gpr_Parser_AdaSAT.Builders.Formula_Builder) return Boolean;
   ...
   function Explain_Contradiction
     (Ctx          : Solving_Context;
      ...
      Invalid_Vars : in out Index_Set) return Gpr_Parser_AdaSAT.Clause;
   ...
   procedure Explain_Topo_Sort_Failure
     (Ctx          : in out Solving_Context;
      Model        : Gpr_Parser_AdaSAT.Model;
      Explanation  : in out Gpr_Parser_AdaSAT.Builders.Formula_Builder);
   ...
   function Check
     (Ctx            : in out Solving_Context;
      Model          : Gpr_Parser_AdaSAT.Model;
      Contradictions : in out Gpr_Parser_AdaSAT.Formulas.Formula) return Boolean;
   ...
   function Encode_Relation
     (Self           : Compound_Relation;
      Ctx            : in out Solving_Context;
      Variable_Count : out Gpr_Parser_AdaSAT.Variable_Or_Null)
      return Gpr_Parser_AdaSAT.Formulas.Formula;
   ...
   package Adalog_Theory is new Gpr_Parser_AdaSAT.Theory (Solving_Context, Check);
   package DPLL_Adalog is new Gpr_Parser_AdaSAT.DPLL (Adalog_Theory);
   ...
   function Explain_Contradiction
     (Ctx          : Solving_Context;
      ...
      Invalid_Vars : in out Index_Set) return Gpr_Parser_AdaSAT.Clause
   is
      use Gpr_Parser_AdaSAT;

      Reason   : Gpr_Parser_AdaSAT.Builders.Clause_Builder;
   ...
   is
      ...
      procedure Contradict_Unset_Var (V : Logic_Var) is
         V_Id   : constant Natural := Id (V);
         Result : Gpr_Parser_AdaSAT.Builders.Clause_Builder;
      begin
         if Solv_Trace.Is_Active then
   ...
   is
      ...
      Problem  : Gpr_Parser_AdaSAT.Builders.Formula_Builder;
      ...
      begin
         if Rels.Length = 0 then
            ...
            declare
               ...
               CB : Gpr_Parser_AdaSAT.Builders.Clause_Builder;
   ...
   function Image_Header (Self : Relation) return String is
      Prefix : constant String :=
        (if Self.Id = 0
         then ""
         else "[" & Gpr_Parser_Support.Images.Stripped_Image (Self.Id) & "] ");
