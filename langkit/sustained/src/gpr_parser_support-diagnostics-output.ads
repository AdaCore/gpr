...
--  :ada:ref:`Gpr_Parser_Support.Diagnostics.Diagnostic` for a source buffer, in a
...
package Gpr_Parser_Support.Diagnostics.Output is
...
end Gpr_Parser_Support.Diagnostics.Output;
