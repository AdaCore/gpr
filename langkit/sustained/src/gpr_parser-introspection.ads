...
package Gpr_Parser.Introspection is
   ...
   function As_Node (Self : Value_Type) return Gpr_Node
      with Pre => Kind (Self) = Node_Value;
   function Create_Node
     (Value : Gpr_Node'Class) return Value_Type;
      ...
      function Create_Grammar_Rule
        (Value : Grammar_Rule) return Value_Type;
         ...
         function As_Gpr_Node_Array (Self : Value_Type) return Gpr_Node_Array
            with Pre => Kind (Self) = Gpr_Node_Array_Value;
         function Create_Gpr_Node_Array
           (Value : Gpr_Node_Array) return Value_Type;
...
private
   ...
   No_Value : constant Any_Value_Type :=
     (Value => (Ada.Finalization.Controlled with Value => null));
         ...
         type Gpr_Node_Array_Access is access all Gpr_Node_Array;
         procedure Free is new Ada.Unchecked_Deallocation
           (Gpr_Node_Array, Gpr_Node_Array_Access);
