...
package Gpr_Parser_Support.Lexical_Envs_Impl is
   ...
   package Entity_Vectors is new Gpr_Parser_Support.Vectors
   ...
   package Referenced_Envs_Vectors is new Gpr_Parser_Support.Vectors
     (Referenced_Env);
   ...
   package Lookup_Result_Item_Vectors is new Gpr_Parser_Support.Vectors
   ...
   package Lexical_Env_Vectors is new Gpr_Parser_Support.Vectors (Lexical_Env);
   ...
   package Internal_Map_Node_Vectors is new Gpr_Parser_Support.Vectors
     (Internal_Map_Node);
