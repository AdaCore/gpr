...
generic
   ...
   with package Iterators is new Gpr_Parser_Support.Iterators
     (Node_Type, Node_Array);

package Gpr_Parser_Support.Tree_Traversal_Iterator is
...
private
   ...
   package Natural_Vectors is new Gpr_Parser_Support.Vectors (Natural);
...
end Gpr_Parser_Support.Tree_Traversal_Iterator;
