...
#define QUEX_TKN_AMP              ((QUEX_TYPE_TOKEN_ID)29)
#define QUEX_TKN_ARROW            ((QUEX_TYPE_TOKEN_ID)33)
#define QUEX_TKN_ASSIGN           ((QUEX_TYPE_TOKEN_ID)32)
#define QUEX_TKN_AT               ((QUEX_TYPE_TOKEN_ID)5)
#define QUEX_TKN_CASE             ((QUEX_TYPE_TOKEN_ID)6)
#define QUEX_TKN_CHAR             ((QUEX_TYPE_TOKEN_ID)37)
#define QUEX_TKN_COLON            ((QUEX_TYPE_TOKEN_ID)26)
#define QUEX_TKN_COMMA            ((QUEX_TYPE_TOKEN_ID)27)
#define QUEX_TKN_DEDENT           ((QUEX_TYPE_TOKEN_ID)4096)
#define QUEX_TKN_DOT              ((QUEX_TYPE_TOKEN_ID)28)
#define QUEX_TKN_END              ((QUEX_TYPE_TOKEN_ID)7)
#define QUEX_TKN_EXTENDS          ((QUEX_TYPE_TOKEN_ID)20)
#define QUEX_TKN_EXTERNAL         ((QUEX_TYPE_TOKEN_ID)21)
#define QUEX_TKN_EXTERNAL_AS_LIST ((QUEX_TYPE_TOKEN_ID)22)
...
#define QUEX_TKN_NUMBER           ((QUEX_TYPE_TOKEN_ID)35)
#define QUEX_TKN_OTHERS           ((QUEX_TYPE_TOKEN_ID)12)
#define QUEX_TKN_PACKAGE          ((QUEX_TYPE_TOKEN_ID)13)
#define QUEX_TKN_PAR_CLOSE        ((QUEX_TYPE_TOKEN_ID)24)
#define QUEX_TKN_PAR_OPEN         ((QUEX_TYPE_TOKEN_ID)23)
#define QUEX_TKN_PIPE             ((QUEX_TYPE_TOKEN_ID)31)
#define QUEX_TKN_PROJECT          ((QUEX_TYPE_TOKEN_ID)19)
#define QUEX_TKN_RENAMES          ((QUEX_TYPE_TOKEN_ID)14)
#define QUEX_TKN_SEMICOLON        ((QUEX_TYPE_TOKEN_ID)25)
#define QUEX_TKN_STRING           ((QUEX_TYPE_TOKEN_ID)34)
#define QUEX_TKN_TERMINATION      ((QUEX_TYPE_TOKEN_ID)0)
#define QUEX_TKN_TICK             ((QUEX_TYPE_TOKEN_ID)30)
