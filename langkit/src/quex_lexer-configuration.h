...
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION__QUEX___QUEX_LEXER
#define __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION__QUEX___QUEX_LEXER
...
#define QUEX_SETTING_BUILD_DATE        "Mon Jun 19 17:04:28 2017"
...
#   define QUEX_FUNCTION_PREFIX        quex_quex_lexer_
#   define QUEX_FUNCTION_DEF_PREFIX    quex_quex_lexer_
    /* In 'C' there are no namespaces, so namespaces are coded directly
     * into the type name. Both, global and local names are equal.       */
#   define QUEX_TYPE0_ANALYZER         struct quex_quex_lexer_tag
#   define QUEX_TYPE_ANALYZER          struct quex_quex_lexer_tag
#   define QUEX_NAME_COMPLETE_ANALYZER quex_quex_lexer
#   define QUEX_TYPE_DERIVED_ANALYZER  struct quex_quex_lexer_tag
...
#   define QUEX_NAMESPACE_MAIN         quex_quex_lexer
...
#   define QUEX_NAME(NAME)             quex_quex_lexer_ ## NAME
...
#   define QUEX_FUNCTION_PREFIX_BACKUP       quex_quex_lexer_
#   define QUEX_FUNCTION_DEF_PREFIX_BACKUP   quex_quex_lexer_
...
#   define QUEX_FUNCTION_PREFIX        quex::
     ...
     * and token.                                                        */
#   define QUEX_TYPE0_ANALYZER         quex_lexer
#   define QUEX_TYPE_ANALYZER          quex::quex_lexer
#   define QUEX_NAME_COMPLETE_ANALYZER quex::quex_lexer
#   define QUEX_TYPE_DERIVED_ANALYZER  quex_lexer
...
#   define QUEX_MEMBER(NAME)           quex_lexer::NAME                
    /* When creating a 'shared token class', macros are temporarily redefined.
     * This happens to generate converters in the token's namespace. After 
     * that, the original macros need to be restored. Thus: Backup!          */  
...
#   define QUEX_TYPE_TOKEN_ID        uint16_t
#endif
...
#endif /* __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION__QUEX___QUEX_LEXER */
