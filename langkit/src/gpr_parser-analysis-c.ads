...
package GPR_Parser.Analysis.C is
   ...
   type gpr_logic_var_type is new System.Address;
   --  Data type for logic variables. For internal use only.

   type gpr_equation_type is new System.Address;
   --  Data type for equation types. For internal use only.

   type gpr_env_rebindings_type is new System.Address;
   ...
   function gpr_node_is_ghost (Node : gpr_base_node) return int
      with Export        => True,
           Convention    => C,
           External_name => "gpr_node_is_ghost";
   ...
   function gpr_lookup_in_node
     (Node : gpr_base_node;
      Sloc : gpr_source_location) return gpr_base_node
      with Export        => True,
           Convention    => C,
   ...
   function gpr_node_child
     (Node    : gpr_base_node;
      N       : unsigned;
      Child_P : access gpr_base_node) return int
      with Export        => True,
           Convention    => C,
...
subtype gpr_gpr_node_array is GPR_Node_Array_Access;
type gpr_gpr_node_array_Ptr is access GPR_Node_Array_Access;

procedure gpr_gpr_node_array_inc_ref (A : GPR_Node_Array_Access)
   with Export        => True,
        Convention    => C,
...
subtype gpr_lexical_env_array is Lexical_Env_Array_Access;
type gpr_lexical_env_array_Ptr is access Lexical_Env_Array_Access;

procedure gpr_lexical_env_array_inc_ref (A : Lexical_Env_Array_Access)
   with Export        => True,
        Convention    => C,
        External_name => "gpr_lexical_env_array_inc_ref";
...
subtype gpr_entity_array is Entity_Array_Access;
type gpr_entity_array_Ptr is access Entity_Array_Access;

procedure gpr_entity_array_inc_ref (A : Entity_Array_Access)
   with Export        => True,
        Convention    => C,
        External_name => "gpr_entity_array_inc_ref";

procedure gpr_entity_array_dec_ref (A : Entity_Array_Access)
   with Export        => True,
        Convention    => C,
        External_name => "gpr_entity_array_dec_ref";



   function gpr_lexical_env_empty return gpr_lexical_env
      with Export        => True,
           Convention    => C,
           External_name => "gpr_lexical_env_empty";
   ...
   function gpr_lexical_env_get
     (Env : gpr_lexical_env; Name : gpr_text)
      return Entity_Array_Access
      with Export        => True,
           Convention    => C,
   ...
   procedure gpr_lexical_env_inc_ref
     (Env : gpr_lexical_env)
      with Export        => True,
           Convention    => C,
           External_name => "gpr_lexical_env_inc_ref";
   ...
   procedure gpr_env_rebindings_inc_ref
     (Self : gpr_env_rebindings_type)
      with Export        => True,
           Convention    => C,
           External_name => "gpr_env_rebindings_inc_ref";

   procedure gpr_env_rebindings_dec_ref
     (Self : gpr_env_rebindings_type)
      with Export        => True,
           Convention    => C,
           External_name => "gpr_env_rebindings_dec_ref";
   ...
   procedure gpr_equation_inc_ref
     (Self : gpr_equation_type)
      with Export        => True,
           Convention    => C,
           External_name => "gpr_equation_inc_ref";

   procedure gpr_equation_dec_ref
     (Self : gpr_equation_type)
      with Export        => True,
           Convention    => C,
           External_name => "gpr_equation_dec_ref";
   ...
   --  slice if Last actually appears before First. Put the result in RESULT.
   --
   --  This returns 0 if First and Last don't belong to the same analysis unit.
...
subtype gpr_entity is Entity;
type gpr_entity_Ptr is access Entity;

procedure gpr_entity_inc_ref (R : gpr_entity_Ptr)
   with Export        => True,
        Convention    => C,
        External_name => "gpr_entity_inc_ref";
procedure gpr_entity_dec_ref (R : gpr_entity_Ptr)
   with Export        => True,
        Convention    => C,
        External_name => "gpr_entity_dec_ref";
...
subtype gpr_entity_info is Entity_Info;
type gpr_entity_info_Ptr is access Entity_Info;

procedure gpr_entity_info_inc_ref (R : gpr_entity_info_Ptr)
   with Export        => True,
        Convention    => C,
        External_name => "gpr_entity_info_inc_ref";
procedure gpr_entity_info_dec_ref (R : gpr_entity_info_Ptr)
   with Export        => True,
        Convention    => C,
        External_name => "gpr_entity_info_dec_ref";
...
subtype gpr_metadata is Metadata;
type gpr_metadata_Ptr is access Metadata;
   ...
   function Wrap is new Ada.Unchecked_Conversion
     (Logic_Var, gpr_logic_var_type);
   function Unwrap is new Ada.Unchecked_Conversion
     (gpr_logic_var_type, Logic_Var);

   function Wrap is new Ada.Unchecked_Conversion
     (Env_Rebindings, gpr_env_rebindings_type);
   function Unwrap is new Ada.Unchecked_Conversion
     (gpr_env_rebindings_type, Env_Rebindings);

   function Wrap is new Ada.Unchecked_Conversion
     (Logic_Equation, gpr_equation_type);
   function Unwrap is new Ada.Unchecked_Conversion
     (gpr_equation_type, Logic_Equation);
