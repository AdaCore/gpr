...
GPR2BUILD_NAME = "GPR2BUILD_NAME"
GPR2CLEAN_NAME = "GPR2CLEAN_NAME"
...
GPR2BUILD = os.environ[GPR2BUILD_NAME] if GPR2BUILD_NAME in os.environ else "gpr2build"
GPR2CLEAN = os.environ[GPR2CLEAN_NAME] if GPR2CLEAN_NAME in os.environ else "gpr2clean"
