...
for lib in "libgnat", "libgnarl":
    ...
    # ... except on x86-windows (or its mingwin variant) where the dlls always
    # hold a ref to themselves for some reason

    if bnr.host_platform not in ["x86-windows", "i686-pc-mingw32"]:
